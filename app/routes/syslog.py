...
#:
#: Восемь штук это не украшательство: на парке из полусотни точек в ленте
#: живут несколько разных сюжетов сразу - падения туннелей, дребезг вайфая,
#: аренды DHCP, чужие попытки входа, - и пяти цветов на них не хватает.
#: Больше восьми смысла нет: различать оттенки в бегущей ленте человек
#: перестаёт, и подсветка превращается в шум.
#:
#: Ключи менять нельзя: они лежат в базе у заведённых правил.
COLORS = {
    "err": "красный",
    "warn": "жёлтый",
    "orange": "оранжевый",
