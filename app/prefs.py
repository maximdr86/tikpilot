...
FIELDS: tuple[Field, ...] = (
    ...
    Field("MONITOR_SESSION_TIMEOUT", "monitor_session_timeout", "int", "Мониторинг",
          ...
          2, 120),
    Field("SSH_TIMEOUT", "ssh_timeout", "int", "Мониторинг",
          "Ждать рукопожатия SSH, секунд",
          "Столько панель ждёт приветствия и входа по SSH. На слабой плате"
          " и на канале с потерями рукопожатие не укладывается в десять"
          " секунд, и массовая команда падает с «No existing session».",
          5, 120),
